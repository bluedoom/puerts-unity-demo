...
if (UnityEngine_Debug) {
    ...
    var getStackTrace = function (name, func) {
        var obj = { name: name };
    ...
    console.log = function() {
        ...
        UnityEngine_Debug.Log(getStackTrace(toString(arguments), console.log));
    }
    
    console.info = function() {
        if (console_org) console_org.info.apply(null, Array.prototype.slice.call(arguments));
        UnityEngine_Debug.Log( getStackTrace(toString(arguments), console.info));
    }
    
    console.warn = function() {
        if (console_org) console_org.warn.apply(null, Array.prototype.slice.call(arguments));
        UnityEngine_Debug.LogWarning( getStackTrace(toString(arguments), console.warn));
    }
    
    console.error = function() {
        if (console_org) console_org.error.apply(null, Array.prototype.slice.call(arguments));
        UnityEngine_Debug.LogError( getStackTrace(toString(arguments), console.error));
    }
